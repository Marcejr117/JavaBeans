        ...
        protected void paintComponent(Graphics g) {
            ...
            if( opacidad>=0 && opacidad <=1){
                if (backgroundColor != null) {
                    graphics.setColor(new Color(backgroundColor.getRed(),backgroundColor.getGreen(),backgroundColor.getBlue(),opacidad));
                } else {
                    graphics.setColor(getBackground());
                }  
            }else{
                JOptionPane.showMessageDialog(this,"la opacidad debe estar entre 0 y 1");
            }
